...
export type FrameType = 'hearts' | 'sparkles' | 'balloons' | 'stars' | 'confetti' | 'cake';
...
const frames: Record<FrameType, ReactNode> = {
  ...
  balloons: (
    <div className="absolute inset-0 pointer-events-none overflow-hidden">
      ...
      <div className="absolute top-1/4 -left-3 text-2xl animate-float" style={{ animationDelay: '1s' }}>🎈</div>
      <div className="absolute top-1/4 -right-3 text-2xl animate-float" style={{ animationDelay: '1.5s' }}>🎈</div>
      <div className="absolute -bottom-2 left-1/4 text-2xl animate-float" style={{ animationDelay: '0.3s' }}>🎈</div>
      <div className="absolute -bottom-2 right-1/4 text-2xl animate-float" style={{ animationDelay: '0.8s' }}>🎈</div>
    </div>
  ),
  stars: (
    <div className="absolute inset-0 pointer-events-none overflow-hidden">
